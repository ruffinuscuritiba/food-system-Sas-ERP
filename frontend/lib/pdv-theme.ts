...
export const PDV_THEME_PRESETS: PdvPreset[] = [
  ...
  {
    name:        "Stripe Violeta",
    description: "Peso e autoridade — o roxo/índigo que grandes SaaS internacionais usam pra parecer sério",
    emoji:       "🔮",
    config: {
      sidebarBg:    "#0B0B14",
      categoriesBg: "#0D0D18",
  ...
  },
  {
    ...
    description: "Tons leves, quentes e artesanais — aconchego premium pra padarias, cafés e pizzarias",
    emoji:       "🍂",
    config: {
      sidebarBg:    "#FFFFFF",
      categoriesBg: "#FBF3EC",
      ...
      primary:      "#C2622D",
      accent:       "#8A9A5B",
      border:       "rgba(194,98,45,0.14)",
      hoverBg:      "rgba(194,98,45,0.06)",
      shadows:      true,
      animations:   true,
      glassmorphism: false,
      darkProducts: false,
